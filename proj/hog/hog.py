...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    """
    >>> fixed_dice = make_test_dice(4, 5, 1)
...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    abs_player, abs_opp = 0, 0
    ones_player, ones_opp = player_score % 10, opponent_score % 10
    tens_player, tens_opp = player_score // 10, opponent_score // 10
    if player_score < 100:
        abs_player = abs(ones_player - tens_player)
    else:
        abs_player = abs(ones_player - (tens_player % 10))
    if opponent_score < 100:
        abs_opp = abs(ones_opp - tens_opp)
    else:
        abs_opp = abs(ones_opp - (tens_opp % 10))
    if abs_opp == abs_player:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        say(score0, score1) = commentary_func()
